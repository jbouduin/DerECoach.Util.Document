...
namespace Bouduin.Util.Document.Rtf.Contents.Table
{
    ...
    public class RtfTableCellStyle
    {
        ...
        private readonly RtfTableCellBorders _borders = new RtfTableCellBorders();
        ...
        {
            cellStyle._verticalAlign = _verticalAlign;

            _borders.Top.CopyTo(cellStyle._borders.Top);
            _borders.Left.CopyTo(cellStyle._borders.Left);
            _borders.Bottom.CopyTo(cellStyle._borders.Bottom);
            _borders.Right.CopyTo(cellStyle._borders.Right);

            cellStyle._textFlow = _textFlow;
        }
