...
namespace Bouduin.Util.Document.Rtf.Header
{
    ...
    /// </summary>
    public class RtfColorCollection: ICollection<DocumentColor>, IEnumerable<DocumentColor>
    {
        private readonly List<DocumentColor> list;
        ...
        public DocumentColor this[int index]
        {
        ...
        {
            list = new List<DocumentColor>();

            list.Add(DocumentColor.Auto);
        }
        ...
        /// </summary>
        public void Add(DocumentColor rtfColor)
        {
            list.Add(rtfColor);
        }
        ...
        /// </summary>
        public void AddRange(DocumentColor[] rtfColors)
        {
            foreach (var color in rtfColors)
            {
                Add(color);
            }
        }
        ...
        public bool Contains(DocumentColor rtfColor)
        {
        ...
        public void CopyTo(DocumentColor[] array, int arrayIndex)
        {
        ...
        public bool Remove(DocumentColor rtfColor)
        {
            var result = list.Remove(rtfColor);
        ...
        bool ICollection<DocumentColor>.IsReadOnly
        {
            get { return false; }
        }

        IEnumerator<DocumentColor> IEnumerable<DocumentColor>.GetEnumerator()
        {
