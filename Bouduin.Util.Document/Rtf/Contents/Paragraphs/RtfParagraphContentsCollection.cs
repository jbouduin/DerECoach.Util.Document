...
namespace Bouduin.Util.Document.Rtf.Contents.Paragraphs
{
    ...
    /// </summary>
    public class RtfParagraphContentsCollection : ICollection<RtfParagraphContentBase>
    {
        private readonly ARtfParagraph Paragraph;
        private readonly List<RtfParagraphContentBase> list;
        ...
        internal RtfParagraphContentsCollection(ARtfParagraph owner)
        {
        ...
        private void OnAddingItem(RtfParagraphContentBase item)
        {
            ...
            item.ParagraphInternal = Paragraph;
        }
