...
namespace Bouduin.Util.Document.Rtf.Contents.Paragraphs
{
    ...
    /// </summary>
    public class RtfParagraphCollection: ICollection<RtfParagraph>
    {
        private readonly ARtfParagraph Parent;
        private readonly List<RtfParagraph> list;
        ...
        internal RtfParagraphCollection(ARtfParagraph parent)
        {
        ...
        {
            foreach (var paragraph in rtfParagraphs)
            {
                Add(paragraph);
            }
        }
